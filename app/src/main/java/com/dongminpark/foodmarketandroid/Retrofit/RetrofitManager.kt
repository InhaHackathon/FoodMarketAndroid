...
class RetrofitManager {
    ...
    fun boardCreate(productName: String, productImg: String, expirationDate: String, price: Int, description: String, completion: (RESPONSE_STATE) -> Unit){
    ...
    fun boardList(completion: (RESPONSE_STATE) -> Unit) { // Unit이 아니라 반환타입으로 변경 필요
    ...
    fun boardListBoardId(boardId: Int, completion: (RESPONSE_STATE) -> Unit){ // 반환타입 Unit에서 변경필요
